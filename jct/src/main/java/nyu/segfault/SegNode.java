...
/**
 * handles the creation of the vTable and dataLayout nodes from javaASTs.
 */
public class SegNode{
	...
	return addToTree;
	    ...
	    // Parses a ConstructorDeclaration from JavaAST to a similar one in the inheritance tree
